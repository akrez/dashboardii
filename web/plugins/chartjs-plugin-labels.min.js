...
(function () {
      ...
      switch (this.options.render) {
        ...
        case "image":
          label = this.options.images[index]
            ? this.loadImage(this.options.images[index], 0)
            : "";
          break;
        case "percentage":
        default:
  ...
  Label.prototype.getFontColor = function (dataset, element, index) {
    ...
    if (typeof fontColor === "function") {
      ...
      fontColor =
        fontColor[index] || this.chart.config.options.defaultFontColor;
    }
    return fontColor;
  };
  ...
  Label.prototype.getBaseRenderInfo = function (element, label) {
    if (
      this.options.position === "outside" ||
      this.options.position === "border"
    ) {
      var renderInfo,
        rangeFromCentre,
        view = element._view,
  ...
  Label.prototype.loadImage = function (obj, from) {
